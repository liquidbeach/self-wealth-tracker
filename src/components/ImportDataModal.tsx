  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-[#1c1c28] rounded-xl shadow-xl w-full max-w-lg">
          {/* Header */}
            ...
            {importStatus === 'idle' && (
              <div className="space-y-4">
                ...
                <label className="block">
                  <div className="border-2 border-dashed border-gray-700 rounded-lg p-8 text-center hover:border-blue-500 hover:bg-blue-500/100/15 transition-colors cursor-pointer">
                    <FileJson className="w-12 h-12 mx-auto text-gray-500 mb-3" />
            ...
            {importStatus === 'preview' && importData && (
              <div className="space-y-4">
                <div className="bg-white/5 rounded-lg p-4">
                  <h3 className="font-medium text-white mb-2">Import Preview</h3>
              ...
              <div className="space-y-4 text-center">
                ...
                <div className="bg-white/5 rounded-lg p-4 text-left">
                  <div className="text-sm space-y-1">
                    <p className="text-green-400">✓ {importResults.success} holdings imported</p>
